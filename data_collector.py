...
def get_base_paths():
    ...
    print(f"Data directory to look in: {data_dir}")
    return data_dir
...
def find_all_recording_folders():
    ...
    print(f"Sub directories for each Device ID found: {participant_dirs}")
    ...
    # print(f"Recording folders (data/Device_ID/csv/Recordings_Signal_Data) found: {recording_folders}")
